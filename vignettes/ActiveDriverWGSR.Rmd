...
5) `element_enriched`: Boolean indicating whether an enrichment of mutations is observed. A value of NA indicates that no mutations fall within the element.

6) `pp_site`: The p-value associated with enrichment of mutations in the sites. A value of NA indicates that no site resides in the element.

7) `site_muts_obs`: Number of patients with mutations in the sites. A value of NA indicates that no site resides in the element.

8) `site_enriched`: Expected number of patients with mutations in the sites. A value of NA indicates that no site resides in the element.
...
11) `has_site_mutations`: "V" indicating the presence of site mutations. An empty string indicates that no site mutations are present.
