...
#'
#' @name post_translational_modification_sites
#'
#' @docType data
#'
#' @usage data(post_translational_modification_sites)
#'
...
#' ActiveDriverWGS(mutations = pancancer_mutations, elements = coding_regions, sites = post_translational_modification_sites)
NULL
